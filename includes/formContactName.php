...
?>
    <h3>Contact Name</h3>
    <p>For Business Contacts the Busness Name is required</p>
    <p>For other types of contacts the first and last names are required</p>
	<br>
	<form method="POST" >
	<table>
	<tr><td><label class="contact-label" for="ct_first_name">First Name</label></td>
		<td><input class="contact-input" type="text" name="ct_first_name" id="ct_first_name" size="50" maxlength="100" value="<?php echo $fname; ?>"></td>
	</tr>
	<tr><td><label class="contact-label" for="ct_last_name">Last Name</label></td>
		<td><input class="contact-input" type="text" name="ct_last_name" id="ct_last_name" size="50" maxlength="100" value="<?php echo $lname; ?>"></td>
	</tr>
<?php if ($_SESSION['ct_type'] == "Business"){ ?>
	<tr><td><label class="contact-label" for="ct_disp_name">Business Name</label></td>
<?php } else{ ?>
	<tr><td><label class="contact-label" for="ct_disp_name">Display Name</label></td>
<?php } ?>
		<td><input class="contact-input" type="text" name="ct_disp_name" id="ct_disp_name" size="50" maxlength="200" value="<?php echo $dname; ?>"></td>
	</tr>
	</table>
	<br>
	<table>
