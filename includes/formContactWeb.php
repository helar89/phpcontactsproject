...
?>
	...
	<form method="POST" >
	<table>
	<tr><td><label class="contact-label" for="we_type">Web Site Type:</label></td>
		<td><select class="contact-input" id="we_type" name="we_type" size="1">
<?php if ($type == ""){ ?>
...
<?php } ?>
	...
	<tr><td><label class="contact-label" for="we_url">Web Site URL</label></td>
		<td><input class="contact-input" type="url" id="we_url" name="we_url" size="50" maxlength="50" value="<?php echo $url; ?>"></td>
	</tr>
	</table>
    <table>
    <tr>
