...
?>
	...
	<form method="POST" >
	<table>
	<tr><td><label class="contact-label" for="ad_type">Address Type:</label></td>
		<td><select class="contact-input" id="ad_type" name="ad_type" size="1">
<?php if ($type == ""){ ?>
...
<?php } ?>
	...
	<tr><td><label class="contact-label" for="ad_line_1">Address Line 1</label></td>
		<td><input class="contact-input" type="text" id="ad_line_1" name="ad_line_1" size="50" maxlength="100" value="<?php echo $line1; ?>"></td>
	</tr>
	<tr><td><label class="contact-label" for="ad_line_2">Address Line 2</label></td>
		<td><input class="contact-input" type="text" id="ad_line_2" name="ad_line_2" size="50" maxlength="100" value="<?php echo $line2; ?>"></td>
	</tr>
	<tr><td><label class="contact-label" for="ad_line_3">Address Line 3</label></td>
		<td><input class="contact-input" type="text" id="ad_line_3" name="ad_line_3" size="50" maxlength="100" value="<?php echo $line3; ?>"></td>
	</tr>
	<tr><td><label class="contact-label" for="ad_city">City</label></td>
		<td><input class="contact-input" type="text" id="ad_city" name="ad_city" size="30" maxlength="50" value="<?php echo $city; ?>"></td>
	</tr>
	<tr><td><label class="contact-label" for="ad_province">Province</label></td>
		<td><input class="contact-input" type="text" id="ad_province" name="ad_province" size="30" maxlength="50" value="<?php echo $province; ?>"></td>
	</tr>
	<tr><td><label class="contact-label" for="ad_post_code">Post Code</label></td>
		<td><input class="contact-input" type="text" id="ad_post_code" name="ad_post_code" size="30" maxlength="50" value="<?php echo $postcode; ?>"></td>
	</tr>
	<tr><td><label class="contact-label" for="ad_country">Country</label></td>
		<td><input class="contact-input" type="text" id="ad_country" name="ad_country" size="30" maxlength="50" value="<?php echo $country; ?>"></td>
	</tr>
	</table>
    <table>
    <tr>
