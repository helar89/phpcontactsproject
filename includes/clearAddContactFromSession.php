...
function clearAddContactFromSession(){
    ...
    if (isset($_SESSION['contact_table'])){
        unset($_SESSION['contact_table']);
    }
    if (isset($_SESSION['contact_address_table'])){
        unset($_SESSION['contact_address_table']);
    }
    if (isset($_SESSION['contact_phone_table'])){
        unset($_SESSION['contact_phone_table']);
    }
    if (isset($_SESSION['contact_contact_email'])){
        unset($_SESSION['contact_contact_email']);
    }
    if (isset($_SESSION['contact_contact_web'])){
        unset($_SESSION['contact_contact_web']);
    }
    if (isset($_SESSION['contact_contact_note'])){
        unset($_SESSION['contact_contact_note']);
    }
}
?>
